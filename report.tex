...
\subsubsection{Genes}
Because the models we use are not perfect, the and- and or- relations between the genes cannot be trusted. We still want the algorithm to return genes and so we have a different implementation than the one given in the introduction. If we cannot take the and- and or- relations into account we can still play 
