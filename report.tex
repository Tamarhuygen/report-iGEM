...
FBA models consist of a set of differential equations that model the flux of mass through reactions.
It is important to note that the base of the model consists of reactions.
...
Assume we want to prevent a certain reaction from happening. Let us call this reaction the primary reaction. Now our algorithm does the following:
\begin{enumerate}
