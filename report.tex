...
\begin{figure}[hbtp]
  \centering
     \input{reaction-overview1.pdftex_t}
      \caption{Schematic overview of a pathway in which carbon compound B is produced, when the net mass flux through reaction 2 becomes zero.}
